...
JSON list interfaces. Provider diagnostics are captured separately so stderr warnings cannot alter
the structured state document. A missing, old/incompatible, timed-out, or state-unreadable CLI leaves
both provider installations unchanged.
